...
INSERT INTO
    task_statuses (id, name, code, description, color, "order")
VALUES
    (
        999,
        'Temporary',
...
SET
    status_id = CASE
        WHEN status_id = 999
        AND temp_old_status_id = 1 THEN 1 -- Old "To Do" -> New "Backlog"
        WHEN status_id = 999
        AND temp_old_status_id = 2 THEN 2 -- Old "In Progress" -> New "In Progress"
        WHEN status_id = 999
        AND temp_old_status_id = 3 THEN 4 -- Old "Done" -> New "Done"
