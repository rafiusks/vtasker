// Package content provides types and functionality for managing task content
package content
...
// CreateInput represents the input for creating task content
...
// UpdateInput represents the input for updating task content
