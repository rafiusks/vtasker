...
// CreateTaskContentInput represents the input for creating task content
type CreateTaskContentInput struct {
...
// UpdateTaskContentInput represents the input for updating task content
